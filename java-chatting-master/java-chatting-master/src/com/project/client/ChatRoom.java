...
public class ChatRoom extends JFrame{
    ...
    public ChatRoom() {
        ...
        liUser.setBackground(new Color(237,239,242));
        liUser.setBackground(new Color(33,34,39));
        liUser.setBorder(BorderFactory.createLineBorder(Color.GRAY, 1, true));
        
        bt_exit = new ExButton("뒤로가기");
        
        p = new JPanel();
        sp_ta.setBounds(10,10,310,570);
        sendTF.setBounds(10,600,290,35);
        add(sendTF);
 
        sp_list.setBounds(310,40, 100, 480);
